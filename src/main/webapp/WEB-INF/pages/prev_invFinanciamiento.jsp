<%-- 
    Document   : prev_invFinanciamiento
    Created on : 19-feb-2016, 15:13:48
    Author     : Luis
--%>
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-white">
            <div class="panel-heading">
                <h4 class="panel-title">Reporte <span class="text-bold">Inventario</span> Por Financiamiento</h4>
            ...
            <div class="panel-body">
               ...
               <form:form method="POST" action="${pageContext.request.contextPath}/Reportes/listReporteInvFianc"  modelAttribute="inventario" id="movF" >
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="control-label">
                                    Fianciamiento<span id="span_marca" class="symbol"></span>
                                </label>
                                <form:input path="marca" type="text" placeholder="Ingrese el finaciamiento" class="form-control" id="factura" onchange="return validaFactura(event);" onblur="return validaFactura(event);" name="marca"/>
                                <span for="marca" class="help-block  no-display" id="span_nombreT">Ingrese tipo de financiacion</span> 
                            </div>
   ...
   function enviarReporte2 ()
    {
     ...
     {
     //alert($('#factura').val());
     window.location.href='${pageContext.request.contextPath}/Reportes/getReporteInvFianc/'+ $('#factura').val() + '/'+$('#mayor option:selected').val() ;
     };
