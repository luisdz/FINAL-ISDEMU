<%-- 
    Document   : prev_invCodigoHist
    Created on : 21-abr-2016, 19:45:59
    Author     : Luis
--%>
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-white">
            <div class="panel-heading">
                <h4 class="panel-title">Reporte <span class="text-bold">Historial Inventario</span> Por Codigo de Activo</h4>
            ...
            <div class="panel-body">
               ...
               <form:form method="POST" action="${pageContext.request.contextPath}/Reportes/listReporteInvHCod"  modelAttribute="inventario" id="movF" >
                    <div class="row">
                        <div class="col-md-12">
   ...
   function enviarReporte2 ()
    {
     ...
     {
     //alert($('#factura').val());
     window.location.href='${pageContext.request.contextPath}/Reportes/getRptInvHistCodigo/'+ $('#factura').val() + '/'+$('#mayor option:selected').val() ;
     };
