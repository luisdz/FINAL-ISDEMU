    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-white">
            ...
            <div class="panel-body">
                ...
                <form:form method="POST" action="${pageContext.request.contextPath}/Inventario/add_porcodigo" onsubmit="return valida_envio();"  modelAttribute="inventario" id="inventarioF" name="inventarioF">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label">
                                    Código Inventario<span id="span_valor" class="symbol"></span>
                                </label>
                                <form:input path="codigoInventario" type="text" placeholder="Ingrese Codigo Inventario" class="form-control" id="cantidadl" name="cantidadl" onkeypress="return valideKey(event);" />
                                <span for="cantidadl" class="help-block  no-display" id="span_valorCT">Ingrese Codigo</span> 
                            </div>
