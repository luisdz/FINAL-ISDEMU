...
function validaClase()
    ...
    function validaAsignadoA()
    {
       
        var x = document.forms["inventarioF"]["personaasig"].value;
        if (x === null || x === "" || x === "0")
        {
         
            $('#span_personaA').removeClass("no-display");            
            $('#span_personaA').closest("div").addClass("has-error");            
             $('#span_personaA').closest("div").removeClass("has-success");
        ...
        else
        {
            ...
            $('#span_personaA').addClass("no-display");
             $('#span_personaA').closest("div").removeClass("has-error");
             $('#span_personaA').closest("div").addClass("has-success");
        }
...
//    };
    ...
    function validaProveedor()
    {
        ...
        var x = document.forms["inventarioF"]["proveedor"].value;
        if (x === null || x === "" || x === "0")
        {
         
            $('#span_proveedorT').removeClass("no-display");            
            $('#span_proveedorT').closest("div").addClass("has-error");            
             $('#span_proveedorT').closest("div").removeClass("has-success");
        ...
        else
        {
            ...
            $('#span_proveedorT').addClass("no-display");
             $('#span_proveedorT').closest("div").removeClass("has-error");
             $('#span_proveedorT').closest("div").addClass("has-success");
        }
